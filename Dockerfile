...
LABEL org.opencontainers.image.title="MediaForest"
LABEL org.opencontainers.image.source="https://github.com/christcb03/mediaforest"
...
ENV MF_DATA_DIR=/data \
    MF_PORT=8080 \
    MF_HOST=0.0.0.0 \
    MF_LOG_LEVEL=info \
    MF_PV_URL=http://phrasevault:8081 \
    MF_MEDIA_DIR=/media
